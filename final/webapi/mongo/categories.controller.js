...
module.exports = { gettAll , insert , updateById , getByCategory, getCategoryByName,deleteCate, getById} // ,, getByKey, updateById, remove
...
async function getByCategory(category){
    try {
        const productsCategory = await productModel.find({'category.categoryId': category});
